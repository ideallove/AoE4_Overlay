...
class MatchEntry:
    ...
    def __init__(self, layout: QtWidgets.QGridLayout, match_data: Dict[str,
        ...
        for item in self.widgets:
            if item != link:
                item.setTextInteractionFlags(QtCore.Qt.TextInteractionFlag.TextSelectableByMouse)
...
class MatchHistoryTab(QtWidgets.QWidget):
    ...
    def __init__(self, parent):
        ...
        self.scroll_layout.addWidget(QtWidgets.QLabel("队伍1"), 0, 0)
        self.scroll_layout.addWidget(QtWidgets.QLabel("队伍2"), 0, 1)
        self.scroll_layout.addWidget(QtWidgets.QLabel("地图"), 0, 2)
        self.scroll_layout.addWidget(QtWidgets.QLabel("开始时间"), 0, 3)
        self.scroll_layout.addWidget(QtWidgets.QLabel("模式"), 0, 4)
        self.scroll_layout.addWidget(QtWidgets.QLabel("结果"), 0, 5)
        self.scroll_layout.addWidget(QtWidgets.QLabel("Rating diff"), 0, 6)
        self.scroll_layout.addWidget(QtWidgets.QLabel("对局详细信息"), 0, 7)
