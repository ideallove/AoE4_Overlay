...
class PlayerWidget:
    ...
    def __init__(self, row: int, toplayout: QtWidgets.QGridLayout):
        ...
        for widget in (self.civ_games, self.civ_winrate, self.civ_median_wins):
            widget.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter | QtCore.Qt.AlignmentFlag.AlignVCenter)
...
class AoEOverlay(OverlayWidget):
    ...
    def initUI(self):
        ...
        layout.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight | QtCore.Qt.AlignmentFlag.AlignTop)
        ...
        self.playerlayout.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight
