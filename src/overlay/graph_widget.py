...
class GraphWidget(QtWidgets.QWidget):
    ...
    def _set_font(qp: QtGui.QPainter,
                  ...
                  color: Union[QtGui.QColor,
                               QtCore.Qt.GlobalColor] = QtGui.QColor("black")):
        pen = qp.pen()
        pen.setColor(color)
        qp.setPen(pen)
    ...
    def _draw_line(self,
                   ...
                   linewidth: int = 2,
                   linestyle: QtCore.Qt.PenStyle = QtCore.Qt.PenStyle.SolidLine,
                   color: Union[QtGui.QColor,
                                QtCore.Qt.GlobalColor] = QtGui.QColor("black")):
    ...
    def _draw_plot(self):
        ...
        for x in x_ticks:
            ...
            qp.drawText(rect, QtCore.Qt.AlignmentFlag.AlignCenter,
        ...
        for y in y_ticks:
            ...
            qp.drawText(rect, QtCore.Qt.AlignmentFlag.AlignRight | QtCore.Qt.AlignmentFlag.AlignVCenter,
        ...
        for idx, data in enumerate(self._data):
            if not data["show"]:
                ...
                qp.drawText(rect, QtCore.Qt.AlignmentFlag.AlignCenter, data['text'])
        ...
        for item in self._data:
            ...
            self._set_font(qp, 10)
            qp.drawText(textbox, QtCore.Qt.AlignmentFlag.AlignLeft | QtCore.Qt.AlignmentFlag.AlignTop,
                        item["label"])
        ...
        qp.drawText(rect, QtCore.Qt.AlignmentFlag.AlignCenter, self.x_label)

        # Y-label
        qp.rotate(-90)
        rect = QtCore.QRect(-box.y - box.height // 2 - 100, 5, 200, 25)
        qp.drawText(rect, QtCore.Qt.AlignmentFlag.AlignCenter, self.y_label)
        qp.rotate(90)

        # Title
        self._set_font(qp, 14)
        rect = QtCore.QRect(box.x + box.width // 2 - 500, -2, 1000, 30)
        qp.drawText(rect, QtCore.Qt.AlignmentFlag.AlignTop | QtCore.Qt.AlignmentFlag.AlignHCenter,
                    self.title)
